...
//    }
    ...
    @Test
    public void loadexception_exists() {
    ...
    @Test(timeout = 1000)
    public void audioplayer_exists() {
    ...
    @Test(timeout = 1000)
    public void imageviewer_exists() {
    ...
    @Test(timeout = 1000)
    public void loadableimage_load() throws Exception {
    ...
    @Test(timeout = 1000)
    public void loadableimage_loadfail() {
        LoadableImage loader = new LoadableImage();
        try {
            loader.load(badImg7);
    ...
    @Test(timeout = 1000)
    public void loadableaudio_load() throws Exception {
    ...
    @Test(timeout = 1000)
    public void loadableaudio_loadfail() {
        LoadableAudio loader = new LoadableAudio();
        try {
            loader.load(badAud3);
    ...
    @Test(timeout = 1000)
    public void textimageviewer_test() throws Exception {
    ...
    @Test(timeout = 1000)
    public void textaudioplayer_test() throws Exception {
    ...
    @Test(timeout = 2000)
    public void multimediaplayer_test() throws Exception {
    ...
    @Test
    public void multimediaplayer_read() throws Exception {
        MultimediaPlayer mp = new MultimediaPlayer();
        try {
            mp.read("badfile.txt");
